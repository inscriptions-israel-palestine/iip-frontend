...
<span class="italic">Select language:</span> <a href="/wordlist/latin">Latin</a> | <a href="/wordlist/greek">Greek</a> | <a href="/wordlist/hebrew">Hebrew</a> | <span class="font-bold">Aramaic</span>
    ...
    <br><br>
This wordlist provides links to the Comprehensive Aramaic Lexicon, indicated with the dictionary icon (<img class="sample-icons" alt="dictionary icon" src="/img/dictionary.png"/>). In addition, it presents Double Tree KWIC visualizations as another lens into the contexts in which these words appear. To view the Double Tree visualization for any word, click the tree icon (<img class="sample-icons" alt="tree icon" src="/img/tree-icon.png"/>).<br><br></p>
