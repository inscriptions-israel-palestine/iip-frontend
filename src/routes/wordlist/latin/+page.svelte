...
<p align="justify" style="padding-left: 200px; padding-right: 80px;">
	The following is the wordlist of Latin in the Inscriptions of Israel/Palestine. The list presents
	each headword, its part of speech, and the number of times that word appears in the corpus. To see
	each of the specific morphological forms, click on the brown button next to the headword. You will
	be presented with a list of word forms, their morphological data, and counts of their appearances
	in the IIP corpus. This display will also show keyword-in-context views, presenting the contexts
	in which these words appear.
	<br /><br />
	This wordlist provides links to the Perseus Latin dictionary, indicated with the dictionary icon (<img
		class="sample-icons"
		alt="dictionary icon"
