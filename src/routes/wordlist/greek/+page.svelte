...
<span class="italic">Select language:</span> <a href="/wordlist/latin">Latin</a> | <span class="font-bold">Greek</span> | <a href="/wordlist/hebrew">Hebrew</a> | <a href="/wordlist/aramaic">Aramaic</a>
    ...
    <br><br>
This wordlist provides links to the Perseus Greek dictionary, indicated with the dictionary icon (<img class="sample-icons" alt="dictionary icon" src="/img/dictionary.png"/>). In addition, it presents Double Tree KWIC visualizations as another lens into the contexts in which these words appear. To view the Double Tree visualization for any word, click the tree icon (<img class="sample-icons" alt="tree icon" src="/img/tree-icon.png"/>).<br><br></p>

<div class="container text-left" style="padding-left: 200px;">

	<table id="latin-pos-table" class="table-auto" width="100%">
		{#each words as word, index}
			<WordListRow {word} id={index+1} language='greek' />
		{/each}
	</table>
</div>
